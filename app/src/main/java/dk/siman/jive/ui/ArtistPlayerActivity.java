...
public class ArtistPlayerActivity extends BaseActivity
        implements ArtistBrowserFragment.MediaFragmentListener {

    private static final String TAG = LogHelper.makeLogTag(ArtistPlayerActivity.class);
    ...
    private void navigateToBrowser(String mediaId) {
        ...
        ArtistBrowserFragment fragment = getBrowseFragment();

        if (fragment == null || !TextUtils.equals(fragment.getMediaId(), mediaId)) {
            fragment = new ArtistBrowserFragment();
            ...
            if (!mediaId.equals(MEDIA_ID_MUSICS_BY_ARTIST)) {
    ...
    private ArtistBrowserFragment getBrowseFragment() {
        return (ArtistBrowserFragment) getFragmentManager().findFragmentByTag(FRAGMENT_TAG);
    }
