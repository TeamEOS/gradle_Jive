...
public class AllPlayerActivity extends BaseActivity
        implements AllBrowserFragment.MediaFragmentListener {

    private static final String TAG = LogHelper.makeLogTag(AllPlayerActivity.class);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.all_activity_player);
    ...
    private void navigateToBrowser(String mediaId) {
        ...
        if (mediaId == null) {
            mediaId = MEDIA_ID_MUSICS_BY_ALPHABET;
        }
        AllBrowserFragment fragment = getBrowseFragment();

        if (fragment == null || !TextUtils.equals(fragment.getMediaId(), mediaId)) {
            fragment = new AllBrowserFragment();
            ...
            if (!mediaId.equals(MEDIA_ID_MUSICS_BY_ALPHABET)) {
    ...
    private AllBrowserFragment getBrowseFragment() {
        return (AllBrowserFragment) getFragmentManager().findFragmentByTag(FRAGMENT_TAG);
    }
