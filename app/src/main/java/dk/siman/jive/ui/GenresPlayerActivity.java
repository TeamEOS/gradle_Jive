 ...
 */
public class GenresPlayerActivity extends BaseActivity
        implements GenresBrowserFragment.MediaFragmentListener {

    private static final String TAG = LogHelper.makeLogTag(GenresPlayerActivity.class);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.genre_activity_player);
    ...
    private void navigateToBrowser(String mediaId) {
        ...
        GenresBrowserFragment fragment = getBrowseFragment();

        if (fragment == null || !TextUtils.equals(fragment.getMediaId(), mediaId)) {
            fragment = new GenresBrowserFragment();
    ...
    private GenresBrowserFragment getBrowseFragment() {
        return (GenresBrowserFragment) getFragmentManager().findFragmentByTag(FRAGMENT_TAG);
    }
