 ...
 */
public class FavoritesPlayerActivity extends BaseActivity
        implements FavoritesBrowserFragment.MediaFragmentListener {

    private static final String TAG = LogHelper.makeLogTag(FavoritesPlayerActivity.class);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.favorite_activity_player);
    ...
    private void navigateToBrowser(String mediaId) {
        ...
        if (mediaId == null) {
            mediaId = MEDIA_ID_MUSICS_BY_FAVORITE;
        }
        FavoritesBrowserFragment fragment = getBrowseFragment();

        if (fragment == null || !TextUtils.equals(fragment.getMediaId(), mediaId)) {
            fragment = new FavoritesBrowserFragment();
            ...
            if (!mediaId.equals(MEDIA_ID_MUSICS_BY_FAVORITE)) {
                LogHelper.d(TAG, "navigateToBrowser, did we go here ? ");
    ...
    private FavoritesBrowserFragment getBrowseFragment() {
        return (FavoritesBrowserFragment) getFragmentManager().findFragmentByTag(FRAGMENT_TAG);
    }
